...
export default function Home() {
  ...
  return (
    <section className="grid grid-cols-4 gap-4">
      <Card className="col-span-2 p-8" isPressable={true} onPress={()=>pressedCard("resume")}>
      ...
      <div></div>
      <div></div>
      <Card className="col-span-2 p-8" isPressable={true} onPress={()=>pressedCard("games")}>
        <h1 className={titleRight({color: "yellow"})}>Games</h1>
        <p>I make a bunch of games. Take a look!</p>
      </Card>
      <Card className="col-span-2 p-8" isPressable={true} onPress={()=>pressedCard("aboutme")}>
